...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter) {
        this.meter = meter;
        setBounds(300, 150, 950, 450);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);

        JLabel heading = new JLabel("UPDATE CUSTOMER INFORMATION");
        heading.setBounds(110, 10, 400, 30);
        heading.setFont(new Font("Seguin Print", Font.BOLD, 20));
        add(heading);
        ...
        ImageIcon i1 = new ImageIcon( "C:\\Users\\Nilesh Singh\\IdeaProjects\\Electricity Billing System\\src\\Com\\Electricty\\Billing\\System\\Icon\\update.png");
        Image i2 = i1.getImage().getScaledInstance(300, 300, Image.SCALE_SMOOTH);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel image = new JLabel(i3);
        image.setBounds(550, 60, 280, 300);
        add(image);
