...
public class CalculateBill extends JFrame implements ActionListener {
    ...
    CalculateBill() {
        ...
        heading.setBounds(130, 20, 400, 25);
        ...
        Image i2 = i1.getImage().getScaledInstance(120, 270, Image.SCALE_SMOOTH);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            // Check if units consumed is empty
            if (units.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please enter units consumed.");
                return; // Exit the actionPerformed method without proceeding further
            }
